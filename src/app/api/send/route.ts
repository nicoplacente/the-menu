...
<a href="#">
  <span style="display: inline-flex; border-radius: 9999px; padding: 2px; overflow: hidden; background-image: linear-gradient(to bottom right, #ec4899, #fb923c);">
    ...
    />
       ...
       <a href="https://example.com/reset-password" style="display: inline-block; background: linear-gradient(90deg, #ec4899, #fb923c); color: #fff; text-decoration: none; text-align: center; padding: 15px 20px; font-size: 14px; font-weight: 500; border-radius: 8px;">Cambiar contraseña</a>
      </td>
    </tr>
  </table>
</body>

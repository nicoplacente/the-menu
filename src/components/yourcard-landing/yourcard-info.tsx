    ...
    <article className="flex xl:items-center gap-12 xl:gap-0 xl:flex-row flex-col xl:justify-evenly">
      ...
      <ul className="flex flex-col gap-9 lg:gap-6 w-full md:max-w-5xl xl:max-w-lg mx-auto">
        ...
        <Link
          ...
          className="relative animate-pulse hover:opacity-70 transition duration-300 inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium  rounded-lg group bg-gradient-to-br to-orange-400 from-pink-500  text-white  focus:ring-4 focus:outline-none focus:ring-pink-800"
        >
